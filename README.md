...
## Environments
- Preview: https://main--xwalk-aem-boiler--dzepeda601.aem.page/
- Live: https://main--xwalk-aem-boiler--dzepeda601.aem.live/
...
1. Open the `xwalk-aem-boiler` directory in your favorite IDE and start coding :)
